...
<br><br><h3>Pagina nu a fost gasita<br><br>Apasa butonul sau asteapta reincarcarea paginii.</h3><br><br>
)=====";

const char page_content_restart[] PROGMEM = R"=====(
<br><br><h3>Repornire dispozitiv<br><br>Apasa butonul sau asteapta reincarcarea paginii.</h3><br><br>
)=====";

const char page_content_erase_settings[] PROGMEM = R"=====(
<br><br><h3>Setarile au fost sterse.<br><br>
Setarile curente sunt inca in memorie, salveaza cel putin datele conexiunii WiFi pentru a pastra conectivitatea inainte de a reporni dispozitivul.<br><br>
Apasa butonul sau asteapta reincarcarea paginii.</h3><br><br>
)=====";

const char page_content_update[] PROGMEM = R"=====(
<br><br><h3>Efectuez actualizare firmare...<br><br>
Apasa butonul sau asteapta reincarcarea paginii.</h3>
Actualizarea dureaza cca. 30-40 secunde.<br><br>
)=====";

const char page_content_main_menu_button[] PROGMEM = R"=====(
<form action="/" type="POST"><input type="submit" value="Meniu principal"></form>
)=====";

const char form_buttons[] PROGMEM = R"=====(
<input type="submit" value="Trimite"><br><br>
<input type="submit" name="save" value="Salveaza configuratia"></form><br>
<form action="/" type="POST"><input type="submit" value="Inapoi"></form><br>
)=====";
...
<form><input type="submit" value="Reincarca pagina"></form><br>
)=====";

const char menu_entry_check_restart[] PROGMEM = R"=====(
onSubmit="if(!confirm('Confirma repornirea dispozitivului...')){return false;}"
)=====";

const char menu_entry_check_erase[] PROGMEM = R"=====(
onSubmit="if(!confirm('Confirma stergerea configuratiei...')){return false;}"
)=====";

const char menu_entry_check_update[] PROGMEM = R"=====(
onSubmit="if(!confirm('Confirma actualizarea firmware...')){return false;}"
)=====";
...
Topic MQTT va fi:<br><input type="text" disabled" value="%s%s%s%s/"><br><br>
)=====";
...
Acest firmware permite conexiuni SSL!
)=====";
...
Porneste MQTT<br>(necesita WiFi)
)=====";

const char txt_fw_name[] PROGMEM = R"=====(
<td>nume FW</td><td>%s</td>
)=====";

const char txt_fw_version[] PROGMEM = R"=====(
<td>versiune FW</td><td>%.2f</td>
)=====";

const char txt_fw_size[] PROGMEM = R"=====(
<td>marime FW</td><td>%.2f KB</td>
)=====";

const char txt_free_flash_size[] PROGMEM = R"=====(
<td>spatiu liber flash</td><td>%.2f KB</td
)=====";
...
Citeste date panel (autentificare necesara)
)=====";

const char txt_paradox_panel_data_periodic[] PROGMEM = R"=====(
Citire panel periodica (nu = mod continuu)
)=====";
...
Pauza intre citiri panel (secunde)
)=====";
...
<h3>Actualizare data/ora Paradox</h3>
)=====";
...
<br><br><form action='/' method="POST"><input type='submit' value='Inapoi'></form>
)=====";